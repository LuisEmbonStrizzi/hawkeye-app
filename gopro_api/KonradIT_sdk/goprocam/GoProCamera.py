...
class GoPro:
    ...
    def __init__(self, camera="detect", ip_address="10.5.5.9", mac_address="38:ba:f8:a9:16:c7", debug=True, timeout=5, webcam_device="usb0", api_type=constants.ApiServerType.OPENGOPRO):
