...
const Topbar: React.FC<AlignCornersProps> = ({ step, handleStep }) => {
  return (
    <header className="fixed top-0 flex w-full justify-center border-b border-background-border bg-background text-sm text-foreground-important">
      <div className="flex w-full max-w-xl px-4 py-[10px]">
