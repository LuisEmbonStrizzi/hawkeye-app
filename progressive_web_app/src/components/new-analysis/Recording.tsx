  ...
  */
  ...
  async function stopRecording() {
    try {
      ...
      // }
      setTimeout(() => {
        setRepe("/video/video_zoom_mvp.mp4");
        setLoading(false);
        setVideo(true);
      }, 3000);
      //setRepe("");
          ...
          <Button
            ...
            icon={
              loading ? (
                ...
                >
                  <path
                    d="M10 18C8.90667 18 7.87333 17.79 6.9 17.37C5.92667 16.95 5.07667 16.3767 4.35 15.65C3.62333 14.9233 3.05 14.0733 2.63 13.1C2.21 12.1267 2 11.0933 2 10C2 8.89333 2.20983 7.85667 2.6295 6.89C3.04917 5.92333 3.62204 5.07667 4.34813 4.35C5.07421 3.62333 5.92353 3.05 6.89608 2.63C7.86864 2.21 8.90115 2 9.9936 2C10.2201 2 10.4028 2.06944 10.5417 2.20833C10.6806 2.34722 10.75 2.52437 10.75 2.73977C10.75 2.95517 10.6806 3.13573 10.5417 3.28144C10.4028 3.42715 10.2222 3.5 10 3.5C8.19896 3.5 6.66537 4.12847 5.39923 5.38542C4.13308 6.64236 3.5 8.17708 3.5 9.98958C3.5 11.8021 4.13308 13.3403 5.39923 14.6042C6.66537 15.8681 8.19896 16.5 10 16.5C11.8194 16.5 13.3576 15.8669 14.6146 14.6008C15.8715 13.3346 16.5 11.801 16.5 10C16.5 9.77778 16.5729 9.59722 16.7186 9.45833C16.8643 9.31944 17.0448 9.25 17.2602 9.25C17.4756 9.25 17.6528 9.31944 17.7917 9.45833C17.9306 9.59722 18 9.77991 18 10.0064C18 11.0989 17.79 12.1314 17.37 13.1039C16.95 14.0765 16.3767 14.9258 15.65 15.6519C14.9233 16.378 14.0767 16.9508 13.11 17.3705C12.1433 17.7902 11.1067 18 10 18Z"
                    fill="#090E1C"
                  />
                </svg>
              ) : (
