        ...
        <div className="flex flex-col gap-[5px]">
          ...
          <div className="relative">
            ...
            <span
              ...
              className="absolute right-[10px] my-[11.5px] cursor-pointer border-l border-secondary-border pl-[10px]"
            >
              {showPassword === true ? (
                <svg
                  width="20"
        ...
        <Button
          ...
          icon={
            loading ? (
              ...
              >
                <path
                  d="M10.2495 18.6235C9.15618 18.6235 8.12285 18.4135 7.14951 17.9935C6.17618 17.5735 5.32618 17.0002 4.59951 16.2735C3.87285 15.5469 3.29951 14.6969 2.87951 13.7235C2.45951 12.7502 2.24951 11.7169 2.24951 10.6235C2.24951 9.51687 2.45935 8.4802 2.87901 7.51353C3.29868 6.54687 3.87155 5.7002 4.59764 4.97354C5.32372 4.24687 6.17304 3.67353 7.1456 3.25353C8.11815 2.83353 9.15066 2.62354 10.2431 2.62354C10.4696 2.62354 10.6523 2.69298 10.7912 2.83187C10.9301 2.97076 10.9995 3.1479 10.9995 3.36331C10.9995 3.57871 10.9301 3.75926 10.7912 3.90497C10.6523 4.05068 10.4717 4.12354 10.2495 4.12354C8.44847 4.12354 6.91488 4.75201 5.64874 6.00895C4.38259 7.2659 3.74951 8.80062 3.74951 10.6131C3.74951 12.4256 4.38259 13.9638 5.64874 15.2277C6.91488 16.4916 8.44847 17.1235 10.2495 17.1235C12.069 17.1235 13.6072 16.4905 14.8641 15.2243C16.121 13.9582 16.7495 12.4246 16.7495 10.6235C16.7495 10.4013 16.8224 10.2208 16.9681 10.0819C17.1138 9.94298 17.2943 9.87354 17.5097 9.87354C17.7251 9.87354 17.9023 9.94298 18.0412 10.0819C18.1801 10.2208 18.2495 10.4034 18.2495 10.6299C18.2495 11.7224 18.0395 12.7549 17.6195 13.7275C17.1995 14.7 16.6262 15.5493 15.8995 16.2754C15.1728 17.0015 14.3262 17.5744 13.3595 17.994C12.3928 18.4137 11.3562 18.6235 10.2495 18.6235Z"
                  className="fill-foreground-important"
                />
              </svg>
            ) : null
          }
